package com.example.sorucevapyarismasi.helper;
...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    private static String DB_NAME = "QuizzitDatabase.db";
    ...
    public DatabaseHelper(Context context) throws IOException
    {
        ...
        if (dbExists)
        {
            ...
            try
            {
                if (createDatabase() == true) { Log.d("DB_LOG", "Database oluşturuldu !"); }
                else { Log.d("DB_LOG", "Database oluşturulamadı !"); }
            }
            catch (Exception e)
            {
